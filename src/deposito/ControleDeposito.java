...
public class ControleDeposito extends javax.swing.JFrame implements Observador{
    ...
    public void atualizar(String msg) {
        depositoListModel.addTexto(msg);
    }


    @Override
    public void qntAdd(int qntAdd) {
       
    }

    @Override
    public void atualizarQntRetirada(int qntRetirada) {
      jLabel5.setText(qntRetirada+"");
    }   

    @Override
    public void atualizarQntAtual(int qntAtual) {
         jLabel5.setText(qntAtual+"");
    }
    ...
    private void initComponents() {
        ...
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            ...
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                deposito.add(ControleDeposito.this);
                
                String qntMax = jtfQtdadeMax.getText();
                int qntMaxConvertida = Integer.parseInt(qntMax);
                deposito.setQtdadeMax(qntMaxConvertida);
                
                String qntCritica = jtfQtdadeCritica.getText();
                int qntCriticaConvertida = Integer.parseInt(qntMax);
                deposito.setQtdadeCritica(qntCriticaConvertida);
                
                jButton1.getClientProperty(deposito);
        ...
        jButton2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                String qnt = jtfQtdade.getText();
                int qntConvertida = Integer.parseInt(qnt);
                try {
                    deposito.add(qntConvertida);
                } catch (Exception ex) {
                    JOptionPane.showMessageDialog(rootPane, ex.getMessage());
                    Logger.getLogger(ControleDeposito.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
        ...
        jButton3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                int qntConvertida = Integer.parseInt(qnt);
                try {
                    deposito.retirar(qntConvertida);
                } catch (Exception ex) {
                    JOptionPane.showMessageDialog(rootPane, ex.getMessage());
                    Logger.getLogger(ControleDeposito.class.getName()).log(Level.SEVERE, null, ex);
                }
